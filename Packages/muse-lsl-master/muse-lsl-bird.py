...
print('Connected')
stop_eeg = [0]
np.savetxt("/home/pi/research_experiments/Experiments/Auditory_Bird_Oddball/Stop_EEG1.csv", (stop_eeg), delimiter=',',fmt="%s")
muse.start()
print('Streaming')

while os.path.isfile("/home/pi/research_experiments/Experiments/Auditory_Bird_Oddball/Stop_EEG1.csv") == True:
    try:
        sleep(1)
    except:
        break
