...
class CLI:
    ...
    def record(self):
        ...
        parser.add_argument("-pn", "--partnum", type=str, default="000",
                            help="Participant Number.")
        
        parser.add_argument("-dv", "--device", type=str, default="Muse",
                            help="Recording Device; Amp, Muse, or Smith.")

        parser.add_argument("-fp", "--filename_path", type=str, default="Some_Experiment",
                            help="Name to call saved file.")

        parser.add_argument("-el", "--exp_loc", type=str, default="Lost_Files",
                            help="Name of experiment folder.")

        args = parser.parse_args(sys.argv[2:])
        from . import record
        record(args.duration, args.filename, args.dejitter, args.type, args.partnum, args.device, args.filename_path, args.exp_loc)
