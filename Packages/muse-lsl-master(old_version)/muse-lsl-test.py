...
print('Connected')
stop_eeg = [0]
np.savetxt("/home/pi/Experiments/N170/Stop_EEG1.csv", (stop_eeg), delimiter=',',fmt="%s")
muse.start()
print('Streaming')

if os.path.isfile("/home/pi/Experiments/Packages/muse-lsl-master/muse/Pause_EEG.csv") == True:
    os.remove("/home/pi/Experiments/Packages/muse-lsl-master/muse/Pause_EEG.csv")
...
##    try:
    ...
    if os.path.isfile("/home/pi/Experiments/Packages/muse-lsl-master/muse/Pause_EEG.csv") == True:
        ...
        backend=options.backend, time_func=local_clock,
        interface=options.interface, name=options.name)
        while os.path.isfile("/home/pi/Experiments/Packages/muse-lsl-master/muse/Pause_EEG.csv") == True:
            try:
                muse.connect()
                print('Connected')
                muse.start()
