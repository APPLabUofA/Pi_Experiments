...
partnum = '001'
device = 'Amp'
filename = 'Perpetual_Auditory_P3'
exp_loc = 'Perpetual_Auditory_P3'
...
standard = '/home/pi/Experiments/Stimuli/Sounds/Auditory_Oddball/low_tone.wav'
target = '/home/pi/Experiments/Stimuli/Sounds/Auditory_Oddball/high_tone.wav'
...
###save times###
while os.path.isfile("/home/pi/Experiments/" + exp_loc + "/Data/" + device + "/Trial_Information/" + partnum + "_" + filename + ".csv") == True:
    if int(partnum) >= 9:
        partnum = "0" + str(int(partnum) + 1)
    else:
        partnum = "00" + str(int(partnum) + 1)

filename_part = ("/home/pi/Experiments/" + exp_loc + "/Data/" + device + "/Trial_Information/" + partnum + "_" + filename + ".csv")
