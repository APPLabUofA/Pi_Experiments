...
if os.path.isfile("/home/pi/research_experiments/Muse_Continue.txt") == False:
    ...
    partnum = "001"
    device = "Muse"
    filename_path = "baseline_stroke_study_gyro"
    ...
    os.system(f"muselsl record --type GYRO --partnum {partnum} --device {device} --filename_path {filename_path} --exp_loc {exp_loc}")
else:
    exit()
