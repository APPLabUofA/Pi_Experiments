...
sound_order = randint(3,4)
target_file = '/home/pi/research_experiments/Experiments/Stimuli/Sounds/Birds/alt_bird_0' + str(sound_order) + '.wav'
standard_file = '/home/pi/research_experiments/Experiments/Stimuli/Sounds/Birds/alt_bird_0' + str(7 - sound_order) + '.wav'
...
instr2 = myfont.render('You will be presented with bird sounds.', True, white)
instr3 = myfont.render('Press spacebar to this bird sound...', True, white)
instr4 = myfont.render('DO NOT press spacebar to this bird sound...', True, white)
...
##    ###present break screen if needed###
##    if i_trial in [999]:
##        send_trigger(200,0,0,2,1)
##        display_break(60)
##        fixation.draw()
##        mywin.flip()
##        core.wait(2)
    ...
    send_trigger(0,15,0,15,0)
    pygame.time.wait(int(delay/2))
    trial_sound_order.append(sound_order)
