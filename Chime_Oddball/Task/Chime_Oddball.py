...
sound_location = '/home/pi/research_experiments/Experiments/Stimuli/Sounds/Chimes/'
...
##    standard_sound = bird_sounds[randint(0,len(bird_sounds))]
chime_sounds = os.listdir(sound_location)

sound_order = randint(0,len(chime_sounds)-1)
target_sound = sound_order
target_file = str(sound_location + chime_sounds[sound_order])
while target_file == str(sound_location + chime_sounds[sound_order]):
    sound_order = randint(0,len(chime_sounds)-1)

standard_sound = sound_order 
standard_file = str(sound_location + chime_sounds[sound_order])
...
instr2 = myfont.render('You will be presented with chimes.', True, white)
instr3 = myfont.render('Press spacebar to this chime...', True, white)
instr4 = myfont.render('DO NOT press spacebar to this chime...', True, white)
