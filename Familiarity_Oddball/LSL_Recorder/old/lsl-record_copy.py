...
while os.path.isfile("/home/pi/Experiments/Auditory_Oddball/Data/Muse_LSL/Muse_LSL_Trigger_Info/%s_%s_muse_lsl_data_auditory_p3.csv"%(partnum,blocknum)) == True:
    blocknum = '0' + str(int(blocknum)+1)
    if int(blocknum) > 3:
        blocknum = '01'
...
filename    = "%s_%s_muse_lsl_data_auditory_p3"%(partnum,blocknum)

default_fname = ("/home/pi/Experiments/Auditory_Oddball/Data/Muse_LSL/Muse_LSL_Trigger_Info/data_%s.csv" % filename)
