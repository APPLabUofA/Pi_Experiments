...
stop_eeg = [0]
np.savetxt("/home/pi/Experiments/Auditory_Oddball/Stop_EEG.csv", (stop_eeg), delimiter=',',fmt="%s")

while os.path.isfile("/home/pi/Experiments/Auditory_Oddball/Data/LSL/Smith/Smith_LSL_Trigger_Info/%s_smith_lsl_data_auditory_p3.csv"%(partnum)) == True:
    partnum = '00'+str(int(partnum)+1)
    if int(partnum) > 9:
        partnum = '0' + str(int(partnum))

filename    = "%s_smith_lsl_data_auditory_p3"%(partnum)

default_fname = ("/home/pi/Experiments/Auditory_Oddball/Data/LSL/Smith/Smith_LSL_Trigger_Info/%s.csv" % filename)
