...
while os.path.isfile("/home/pi/Experiments/Auditory_Oddball/Data/LSL/Muse/Muse_LSL_Trigger_Info/%s_muse_lsl_data_auditory_p3.csv"%(partnum)) == True:
    partnum = '00'+str(int(partnum)+1)
    if int(partnum) > 9:
        partnum = '0' + str(int(partnum))

filename    = "%s_muse_lsl_data_auditory_p3"%(partnum)

default_fname = ("/home/pi/Experiments/Auditory_Oddball/Data/LSL/Muse/Muse_LSL_Trigger_Info/%s.csv" % filename)
