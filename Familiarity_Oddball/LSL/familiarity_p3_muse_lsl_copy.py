...
for i_pic in range(trials):
    ...
    ###now define our trigger to send with LSL###
        ...
        if image_order[i_pic] == 1:
            ...
            if os.path.exists('/home/pi/Experiments/Familiarity_Oddball/Images/' + part_order_temp + '_SFSS_' + str(pic_order_temp) + '.jpg'):
                image_order_temp = 'SFSS'
            else:
                image_order_temp = 'SFBB'
        elif image_order[i_pic] == 2:
            pic_order_temp = random.randint(1,fam_count)
            if os.path.exists('/home/pi/Experiments/Familiarity_Oddball/Images/' + part_order_temp + '_FFSS_' + str(pic_order_temp) + '.jpg'):
    ...
    ###now define our trigger to send with LSL###
        ...
        if image_order[i_pic] == 1:
            pic_order_temp = random.randint(1,s_self_count)
            if coin == 1:
    ...
    trial_img = pygame.image.load('/home/pi/Experiments/Familiarity_Oddball/Images/' + part_order_temp + '_' + image_order_temp + '_' + str(pic_order_temp) + '.jpg')
    print('/home/pi/Experiments/Familiarity_Oddball/Images/' + part_order_temp + '_' + image_order_temp + '_' + str(pic_order_temp) + '.jpg')
    print(trigger)
    ###send triggers###
    timestamp = local_clock()
