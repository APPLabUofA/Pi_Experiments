...
###block one###
###show instructions###
screen.blit(instr[block_order[0]],instr_size[block_order[0]])
pygame.display.flip()
time.sleep(0.1)
key_pressed = 0
pygame.event.clear()
...
pygame.display.flip()
###change duty cycle###
left_eye.ChangeDutyCycle(dc[block_order[0]])
right_eye.ChangeDutyCycle(dc[block_order[0]])
time.sleep(5)
###start task###
GPIO.output(pi2trig(((block_order[0]+1)*10)+1),1)
time.sleep(0.01)
GPIO.output(pi2trig(255),0)
time.sleep(baseline_length)
GPIO.output(pi2trig(((block_order[0]+1)*10)+2),1)
time.sleep(0.01)
GPIO.output(pi2trig(255),0)
time.sleep(1)
###play tone###
...
###block two###
###show instructions###
screen.blit(instr[block_order[1]],instr_size[block_order[1]])
pygame.display.flip()
time.sleep(0.1)
key_pressed = 0
pygame.event.clear()
...
pygame.display.flip()
###change duty cycle###
left_eye.ChangeDutyCycle(dc[block_order[1]])
right_eye.ChangeDutyCycle(dc[block_order[1]])
time.sleep(5)
###start task###
GPIO.output(pi2trig(((block_order[1]+1)*10)+1),1)
time.sleep(0.01)
GPIO.output(pi2trig(255),0)
time.sleep(baseline_length)
GPIO.output(pi2trig(((block_order[1]+1)*10)+2),1)
time.sleep(0.01)
GPIO.output(pi2trig(255),0)
time.sleep(1)
###play tone###
