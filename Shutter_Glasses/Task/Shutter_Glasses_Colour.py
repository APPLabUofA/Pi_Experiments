...
for i_tone in range(len(tones)):
    ...
    if tones[i_tone] == 0:#square
        stim1 = pygame.draw.rect(screen, rect_red , ((x_center-(rect_size/2)),(y_center-(rect_size/2)),rect_size,rect_size))
        trig_type.append(1)
    elif tones[i_tone] == 1:#triangle
        stim1 = pygame.draw.rect(screen, rect_blue , ((x_center-(rect_size/2)),(y_center-(rect_size/2)),rect_size,rect_size))
        trig_type.append(2)
