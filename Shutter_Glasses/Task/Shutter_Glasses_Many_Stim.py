...
for i_tone in range(len(tones)):
    ...
    if tones[i_tone] == 0:#square
        ...
        stim1 = pygame.draw.polygon(screen, rect_white , ((x_center-200,y_center-(rect_size*2)),(x_center-(rect_size/2)-200,y_center-(rect_size)),(x_center+(rect_size/2)-200,y_center-(rect_size))))
        stim2 = pygame.draw.polygon(screen, rect_white , ((x_center,y_center-(rect_size*2)),(x_center-(rect_size/2),y_center-(rect_size)),(x_center+(rect_size/2),y_center-(rect_size))))
        stim3 = pygame.draw.polygon(screen, rect_white , ((x_center+200,y_center-(rect_size*2)),(x_center-(rect_size/2)+200,y_center-(rect_size)),(x_center+(rect_size/2)+200,y_center-(rect_size))))

        stim4 = pygame.draw.polygon(screen, rect_white , ((x_center-200,y_center-(rect_size/2)),(x_center-(rect_size/2)-200,y_center+(rect_size/2)),(x_center+(rect_size/2)-200,y_center+(rect_size/2))))
        stim5 = pygame.draw.polygon(screen, rect_white , ((x_center,y_center-(rect_size/2)),(x_center-(rect_size/2),y_center+(rect_size/2)),(x_center+(rect_size/2),y_center+(rect_size/2))))
        stim6 = pygame.draw.polygon(screen, rect_white , ((x_center+200,y_center-(rect_size/2)),(x_center-(rect_size/2)+200,y_center+(rect_size/2)),(x_center+(rect_size/2)+200,y_center+(rect_size/2))))
        
        stim7 = pygame.draw.polygon(screen, rect_white , ((x_center-200,y_center+(rect_size)),(x_center-(rect_size/2)-200,y_center+(rect_size*2)),(x_center+(rect_size/2)-200,y_center+(rect_size*2))))
        stim8 = pygame.draw.polygon(screen, rect_white , ((x_center,y_center+(rect_size)),(x_center-(rect_size/2),y_center+(rect_size*2)),(x_center+(rect_size/2),y_center+(rect_size*2))))
        stim9 = pygame.draw.polygon(screen, rect_white , ((x_center+200,y_center+(rect_size)),(x_center-(rect_size/2)+200,y_center+(rect_size*2)),(x_center+(rect_size/2)+200,y_center+(rect_size*2))))
        trig_type.append(2)
    ...
    if tones[i_tone] == 0:#square
        ...
        stim1 = pygame.draw.polygon(screen, rect_black , ((x_center-200,y_center-(rect_size*2)),(x_center-(rect_size/2)-200,y_center-(rect_size)),(x_center+(rect_size/2)-200,y_center-(rect_size))))
        stim2 = pygame.draw.polygon(screen, rect_black , ((x_center,y_center-(rect_size*2)),(x_center-(rect_size/2),y_center-(rect_size)),(x_center+(rect_size/2),y_center-(rect_size))))
        stim3 = pygame.draw.polygon(screen, rect_black , ((x_center+200,y_center-(rect_size*2)),(x_center-(rect_size/2)+200,y_center-(rect_size)),(x_center+(rect_size/2)+200,y_center-(rect_size))))

        stim4 = pygame.draw.polygon(screen, rect_black , ((x_center-200,y_center-(rect_size/2)),(x_center-(rect_size/2)-200,y_center+(rect_size/2)),(x_center+(rect_size/2)-200,y_center+(rect_size/2))))
        stim5 = pygame.draw.polygon(screen, rect_black , ((x_center,y_center-(rect_size/2)),(x_center-(rect_size/2),y_center+(rect_size/2)),(x_center+(rect_size/2),y_center+(rect_size/2))))
        stim6 = pygame.draw.polygon(screen, rect_black , ((x_center+200,y_center-(rect_size/2)),(x_center-(rect_size/2)+200,y_center+(rect_size/2)),(x_center+(rect_size/2)+200,y_center+(rect_size/2))))
        
        stim7 = pygame.draw.polygon(screen, rect_black , ((x_center-200,y_center+(rect_size)),(x_center-(rect_size/2)-200,y_center+(rect_size*2)),(x_center+(rect_size/2)-200,y_center+(rect_size*2))))
        stim8 = pygame.draw.polygon(screen, rect_black , ((x_center,y_center+(rect_size)),(x_center-(rect_size/2),y_center+(rect_size*2)),(x_center+(rect_size/2),y_center+(rect_size*2))))
        stim9 = pygame.draw.polygon(screen, rect_black , ((x_center+200,y_center+(rect_size)),(x_center-(rect_size/2)+200,y_center+(rect_size*2)),(x_center+(rect_size/2)+200,y_center+(rect_size*2))))
    pygame.display.update([stim1,stim2,stim3,stim4,stim5,stim6,stim7,stim8,stim9])
